...
public class Adventure {
	...
	public void setUpFiles() throws IOException {
		...
		System.out.print("Where are your adventure files? ");
		
		String name = scan.nextLine();
		System.out.println(name);
		
		File fileObjects = new File(name + "Objects.txt");
		System.out.println(fileObjects.getAbsolutePath());
		
		File fileRooms = new File(name + "Rooms.txt");
		System.out.println(fileRooms.getAbsolutePath());
		
		File fileSynonyms = new File(name + "Synonyms.txt");
		System.out.println(fileSynonyms.getAbsolutePath());
	...
	public void getCommand() {
		if (!quit) {
			...
			if (cmd != null) {
				...
				System.out
						.print("That's not a recognized command! If you need help, type HELP. Please try a new command: ");
